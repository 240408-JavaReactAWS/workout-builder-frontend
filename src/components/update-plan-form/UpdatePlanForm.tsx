...
function UpdatePlanForm() {
    ...
    const getCurrentPlan = async () => {
        try {
            const res = await axios.get(`http://ec2-34-224-100-40.compute-1.amazonaws.com/plans/${id}`, { 
    ...
    const fetchAllExercises = async () => {
        try {
            const res = await axios.get('http://ec2-34-224-100-40.compute-1.amazonaws.com/exercises', {
                 withCredentials: true , headers: { 'Content-Type': 'application/json', 'username': localStorage.getItem("username")}
                });
    ...
    let submitNewForm = async (e: SyntheticEvent) => {
        ...
        try {
            let res = await axios.put('http://ec2-34-224-100-40.compute-1.amazonaws.com/plans', newPlan, { 
                withCredentials: true , headers: { 'Content-Type': 'application/json', 'username': localStorage.getItem("username")}
            });
            if (res.status === 200) {
