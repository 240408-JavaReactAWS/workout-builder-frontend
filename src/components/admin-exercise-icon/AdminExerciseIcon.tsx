...
function AdminExerciseIcon(props:AdminExerciseIconProps) {
    ...
    let updateExercise = async () => {
        ...
        try {
            ...
            updatedExercise, { withCredentials: true , headers: { 'Content-Type': 'application/json', 'username': localStorage.getItem("username")} });
    ...
    let deleteExercise = async () => {
        try {
            const res = await axios.delete(`http://ec2-54-172-227-238.compute-1.amazonaws.com/exercises/${props.exercise.exerciseId}`, 
